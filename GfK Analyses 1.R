...
dat.l <-dat.l %>%
  mutate(MNO.s=MNO, party3.s=party3, wave.s=wave, POS7.s=POS7.r/3, FFB_1.s=FFB_1.r/3, FFB_2.s=FFB_2.r/3,
         ...
         DETH3_D.s=DETH3_D.r/100, PD.ind.s=PD.ind/100, PRR1.s=PRR1.r/4, CP3.s=CP3.r/3, EP1.s=EP1.r/2, 
         EP3.s=EP3.r/2, EP4.s=EP4.r/4, SOC1.s=SOC1.r/4, PER1.s=PER1.r/4, NEWOUT3.s=NEWOUT3.r/3,
         RE15.s=RE15.r/3, RE17.s=RE17.r/3, RE19.s=RE19.r/3, RE22.s=RE22.r/3, re24.ind.s=re24.ind/4, 
         re25.ind.s=re25.ind/4)
